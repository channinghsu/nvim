...
local prompts = {
  ...
  optimize = { name = "优化代码", prompt = "请优化以下代码，使其更简洁、高效或可读性更强。" },
  ...
  doc = { name = "生成文档", prompt = "请根据以下代码生成函数或模块说明文档，使用简体中文。" },
  commit = { name = "撰写提交信息", prompt = "请基于以下改动，生成符合 Conventional Commits 规范的中文提交信息。" },
